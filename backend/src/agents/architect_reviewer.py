    ...
    def __init__(self):
        super().__init__(
            ...
            goals=(
                ...
                "You MUST choose exactly ONE decision from: "
                "ADAPTER_PATTERN, FACADE_PATTERN, COMPATIBILITY_LAYER, MIGRATION_LAYER, WRAPPER_STRATEGY, HUMAN_ESCALATION. "
                "You must supply a reason, migration_cost (LOW, MEDIUM, HIGH), and affected_modules (int). "
                "Your implementation_steps must be concrete. "
                ...
                "For HUMAN_ESCALATION: explain specifically what information is missing to decide."
            ),
            constraints=(
                "You MUST pick one of the 6 enum actions — do not invent a 7th option. "
                "You MUST address both the Advocate's and Defender's strongest arguments in your reason. "
                "Never use free-form text for the final schema output."
            )
        )
