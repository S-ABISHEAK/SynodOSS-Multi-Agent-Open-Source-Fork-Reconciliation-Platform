    ...
    def store_reconciliation_units(self, scan_id: int, units_data: list):
        ...
        for u in units_data:
            unit = ReconciliationUnit(
                ...
                affected_functions=u.get("affected_functions"),
                affected_modules=u.get("affected_modules"),
                critical_paths=u.get("critical_paths"),
                dependency_depth=u.get("dependency_depth"),
                impact_score=u.get("impact_score"),
